...
Recipe.insert(User.find(1).id, "Recipe 1", "Category 1", "Description 1", "Body 1")
Recipe.insert(User.find(2).id, "Recipe 2", "Category 2", "Description 2", "Body 2")
Recipe.insert(User.find(2).id, "Recipe 3", "Category 3", "Description 3", "Body 3")
